"""
Logging configuration for requests-plus.
"""
import logging
...
class RequestsPlusFormatter(logging.Formatter):
    """Custom formatter for requests-plus logs."""
