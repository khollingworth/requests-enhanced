...
try:
    ...
    _OAuth1Session = object
    _OAuth2Session = object
    OAuth1 = object
    OAuth2 = object
...
class OAuthNotAvailableError(RequestsEnhancedError):
    """Raised when OAuth functionality is requested but dependencies are not installed."""
    
    def __init__(self, message: str = "OAuth functionality requires 'requests-oauthlib' package. Install with: pip install requests-enhanced[oauth]"):
...
class OAuth1EnhancedSession(Session):
    ...
    Example:
        ...
        >>> # User authorizes...
        >>> session.fetch_access_token('https://api.example.com/oauth/access_token', verifier='user_verifier')
    ...
    def __init__(
        ...
        **kwargs
        ...
        logger.info(f"OAuth1EnhancedSession initialized with client_key: {client_key[:8]}...")
    ...
    def fetch_access_token(
        ...
        **request_kwargs
        ...
        if verifier:
            self._verifier = verifier
            self._oauth_session.verifier = verifier
...
class OAuth2EnhancedSession(Session):
    ...
    Args:
        ...
        client: OAuth 2.0 client instance (optional)
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Initialize the enhanced Session first (only with Session-compatible kwargs)
        super().__init__(**kwargs)
        ...
        logger.info(f"OAuth2EnhancedSession initialized with client_id: {client_id[:8]}...")
    ...
    def authorization_url(
        ...
        **kwargs
        ...
        logger.info(f"Generating OAuth 2.0 authorization URL from: {authorization_url}")
    ...
    def fetch_token(
        ...
        **kwargs
        ...
        Args:
            ...
            include_client_id: Whether to include client_id in request
        ...
        # Fetch the token using the OAuth session
